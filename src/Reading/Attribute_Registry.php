...
class Attribute_Registry
{
     ...
     */
    private static array $style_attributes = [
     ...
     */
    private static array $style_converters = ['font-size' => Length_Attribute_Converter::class, 'letter-spacing' => Length_Attribute_Converter::class, 'word-spacing' => Length_Attribute_Converter::class];
    /**
     ...
     */
    public static function is_style(string $key): bool
    {
        return in_array($key, self::$style_attributes);
    }
    /**
     ...
     */
    public static function convert_style_attribute(string $key, string $value): string
    {
        if (!isset(self::$style_converters[$key])) {
            return $value;
        }
        $converter = call_user_func([self::$style_converters[$key], 'getInstance']);
